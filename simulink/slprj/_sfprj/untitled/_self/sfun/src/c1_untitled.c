...
static const char * c1_debug_family_names[7] = { "l", "nargin", "nargout", "v",
  "w", "vr", "vl" };
...
static real_T c1_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_b_vl, const char_T *c1_identifier);
...
static void sf_gateway_c1_untitled(SFc1_untitledInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 2U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_b_v, 3U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_b_w, 4U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_b_vr, 5U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_b_vl, 6U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2753010560U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2983219236U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(233021276U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3071444145U);
}
...
mxArray *sf_c1_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("5DJLbAmYs8x46v5OoB524F");
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[7],T\"vl\",},{M[1],M[5],T\"vr\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
...
static void mdlSetWorkWidths_c1_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1436995848U));
  ssSetChecksum1(S,(2860824214U));
  ssSetChecksum2(S,(3193285074U));
  ssSetChecksum3(S,(1178322192U));
