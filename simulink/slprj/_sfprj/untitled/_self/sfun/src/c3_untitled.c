...
static const char * c3_debug_family_names[10] = { "V", "W", "nargin", "nargout",
  "vl", "vr", "theta", "x_dot", "y_dot", "theta_dot" };
...
static real_T c3_emlrt_marshallIn(SFc3_untitledInstanceStruct *chartInstance,
  const mxArray *c3_b_theta_dot, const char_T *c3_identifier);
  ...
  *chartInstance)
{
  ...
  c3_b_hoistedGlobal = *chartInstance->c3_x_dot;
  c3_b_u = c3_b_hoistedGlobal;
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_c_hoistedGlobal = *chartInstance->c3_y_dot;
  ...
  const mxArray *c3_st)
{
  ...
  *chartInstance->c3_theta_dot = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 0)), "theta_dot");
  *chartInstance->c3_x_dot = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 1)), "x_dot");
  *chartInstance->c3_y_dot = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 2)), "y_dot");
...
static void sf_gateway_c3_untitled(SFc3_untitledInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_vl, 0U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *chartInstance->c3_vl;
  c3_b_hoistedGlobal = *chartInstance->c3_vr;
  c3_c_hoistedGlobal = *chartInstance->c3_theta;
  c3_b_vl = c3_hoistedGlobal;
  c3_b_vr = c3_b_hoistedGlobal;
  c3_b_theta = c3_c_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 10U, 10U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_V, 0U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_W, 1U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_vl, 4U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_vr, 5U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_b_theta, 6U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_x_dot, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_y_dot, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_theta_dot, 9U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 2);
  c3_A = c3_b_vr + c3_b_vl;
  c3_x = c3_A;
  c3_b_x = c3_x;
  c3_c_x = c3_b_x;
  c3_V = c3_c_x / 2.0;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 3);
  c3_b_A = c3_b_vr - c3_b_vl;
  c3_d_x = c3_b_A;
  c3_e_x = c3_d_x;
  c3_f_x = c3_e_x;
  c3_W = c3_f_x / 2.0;
  ...
  c3_b_x_dot = c3_V * c3_h_x;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 5);
  c3_i_x = c3_b_theta;
  c3_j_x = c3_i_x;
  c3_j_x = muDoubleScalarSin(c3_j_x);
  c3_b_y_dot = c3_V * c3_j_x;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 6);
  c3_b_theta_dot = c3_W;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -6);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c3_x_dot = c3_b_x_dot;
  *chartInstance->c3_y_dot = c3_b_y_dot;
  *chartInstance->c3_theta_dot = c3_b_theta_dot;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_untitledMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_x_dot, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_vr, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_y_dot, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_theta_dot, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c3_theta, 5U);
}
  ...
  const mxArray *c3_b_theta_dot, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_theta_dot),
    &c3_thisId);
  sf_mex_destroy(&c3_b_theta_dot);
  return c3_y;
}
...
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_b_theta_dot;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  real_T c3_y;
  SFc3_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc3_untitledInstanceStruct *)chartInstanceVoid;
  c3_b_theta_dot = sf_mex_dup(c3_mxArrayInData);
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assert.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1389714174U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1363710280U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 5);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1386420352U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1395324896U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 9);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1395324904U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void init_simulink_io_address(SFc3_untitledInstanceStruct *chartInstance)
{
  chartInstance->c3_vl = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    0);
  chartInstance->c3_x_dot = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c3_vr = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c3_y_dot = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c3_theta_dot = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3117887005U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3000317963U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(997818512U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3057505357U);
}
...
mxArray *sf_c3_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9ynuYuWZ3Md8gDaj0p0np");
...
static const mxArray *sf_get_sim_state_info_c3_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"theta_dot\",},{M[1],M[5],T\"x_dot\",},{M[1],M[7],T\"y_dot\",},{M[8],M[0],T\"is_active_c3_untitled\",}}"
  };
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_COMPILED_PROPS(5,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c3_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c3_vl);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c3_x_dot);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c3_vr);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c3_y_dot);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c3_theta_dot);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c3_theta);
      }
    } else {
...
static void mdlSetWorkWidths_c3_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3620963454U));
  ssSetChecksum1(S,(3649117949U));
  ssSetChecksum2(S,(3820480763U));
  ssSetChecksum3(S,(4059475732U));
