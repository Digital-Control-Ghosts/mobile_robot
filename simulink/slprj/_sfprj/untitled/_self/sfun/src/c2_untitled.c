...
static const char * c2_debug_family_names[5] = { "nargin", "nargout",
  "Theta_desired", "Theta_actual", "Theta_error" };
...
static real_T c2_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_b_Theta_error, const char_T *c2_identifier);
...
static void sf_gateway_c2_untitled(SFc2_untitledInstanceStruct *chartInstance)
{
  ...
  real_T c2_b_Theta_desired;
  real_T c2_b_Theta_actual;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Theta_desired, 0U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, chartInstance->c2_sfEvent);
  c2_hoistedGlobal = *chartInstance->c2_Theta_desired;
  c2_b_hoistedGlobal = *chartInstance->c2_Theta_actual;
  c2_b_Theta_desired = c2_hoistedGlobal;
  c2_b_Theta_actual = c2_b_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_Theta_desired, 2U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_Theta_actual, 3U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_Theta_error, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 4);
  c2_b_Theta_error = c2_b_Theta_desired - c2_b_Theta_actual;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -4);
  ...
  *chartInstance->c2_Theta_error = c2_b_Theta_error;
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c2_Theta_actual, 2U);
}
...
static void init_simulink_io_address(SFc2_untitledInstanceStruct *chartInstance)
{
  chartInstance->c2_Theta_desired = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_Theta_error = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_Theta_actual = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2369338610U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1952275089U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4032467384U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(722177053U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("xNdPc4VzTy0UzTjnxuXe2B");
...
static const mxArray *sf_get_sim_state_info_c2_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Theta_error\",},{M[8],M[0],T\"is_active_c2_untitled\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_untitledInstanceStruct *) chartInfo->chartInstance;
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"Theta_desired");
          _SFD_SET_DATA_PROPS(1,2,0,1,"Theta_error");
          _SFD_SET_DATA_PROPS(2,1,1,0,"Theta_actual");
        ...
        _SFD_SET_DATA_COMPILED_PROPS(2,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c2_sf_marshallOut,(MexInFcnForType)NULL);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c2_Theta_desired);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c2_Theta_error);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c2_Theta_actual);
      }
    } else {
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2360130230U));
  ssSetChecksum1(S,(4051530914U));
  ssSetChecksum2(S,(2203938262U));
  ssSetChecksum3(S,(621782738U));
