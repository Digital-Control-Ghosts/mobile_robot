...
extern void sf_untitled_uses_exported_functions(int nlhs, mxArray * plhs[], int
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1123038890U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(281939294U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2401581578U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(397035315U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3858921898U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2783838265U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3788419631U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3365656185U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "5DJLbAmYs8x46v5OoB524F") == 0) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "xNdPc4VzTy0UzTjnxuXe2B") == 0) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "9ynuYuWZ3Md8gDaj0p0np") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "ZiUjF0aZc0dfgH3yuaAlr") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "QOfw2J41VCfZ5nndyV5MzB") == 0) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "UT020p5uja66Y2CvOqvWXB") == 0) {
...
void sf_untitled_get_post_codegen_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   case 1:
    {
      if (strcmp(tpChksum, "ZiUjF0aZc0dfgH3yuaAlr") == 0) {
        extern mxArray *sf_c1_untitled_get_post_codegen_info(void);
        plhs[0] = sf_c1_untitled_get_post_codegen_info();
        return;
      }
    }
    break;
   ...
   case 2:
    {
      if (strcmp(tpChksum, "QOfw2J41VCfZ5nndyV5MzB") == 0) {
        extern mxArray *sf_c2_untitled_get_post_codegen_info(void);
        plhs[0] = sf_c2_untitled_get_post_codegen_info();
        return;
      }
    }
    break;
   ...
   case 3:
    {
      if (strcmp(tpChksum, "UT020p5uja66Y2CvOqvWXB") == 0) {
        extern mxArray *sf_c3_untitled_get_post_codegen_info(void);
        plhs[0] = sf_c3_untitled_get_post_codegen_info();
        return;
      }
    }
    break;
